...
const LifeSkills = () => {
  const { data: allClasses = [], isLoading } = useClassesBySubject([
    "Life Skills", "Leadership", "Communication", "Public Speaking", "Debate", "Time Management", "Financial Literacy", "Social Skills", "Entrepreneurship"
  ]);
  ...
  return (
    <PageLayout title="Life Skills & Personal Development" description="Build essential life skills through classes in leadership, communication, and more.">
      <MobileSearchBar />
      {isLoading ? (
