...
const ClassCard = ({
  ...
  if (isMobile) {
    return (
      <Link to={`/student/classes/${classId}`} className="block">
        <div className={`bg-white border-b border-gray-200 p-3 cursor-pointer ${
  ...
  return (
    <Link to={`/student/classes/${classId}`} className="block">
      <div className={`rounded-lg overflow-hidden border border-gray-200 bg-white shadow-sm hover:shadow-md transition-all cursor-pointer ${
        isFeatured ? "ring-2 ring-talent-primary" : ""
      }`}>
