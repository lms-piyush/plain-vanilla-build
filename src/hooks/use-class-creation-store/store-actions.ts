...
export type ClassCreationActions = {
  ...
  setSyllabus: (syllabus: { title: string; description: string; learningObjectives: string[]; weekNumber: number; sessionDate: string; startTime: string; endTime: string; status: string; notes: string }[]) => void;
  addSyllabusItem: (item: { title: string; description: string; learningObjectives: string[]; weekNumber: number; sessionDate: string; startTime: string; endTime: string; status: string; notes: string }) => void;
  removeSyllabusItem: (index: number) => void;
  updateSyllabusItem: (index: number, item: { title: string; description: string; learningObjectives: string[]; weekNumber: number; sessionDate: string; startTime: string; endTime: string; status: string; notes: string }) => void;
