  ...
  loadExistingClassData: async (classId: string) => {
    try {
      ...
      set((state) => ({
        ...
        deliveryMode: classData.delivery_mode as any,
        classFormat: classData.class_format as any,
        classSize: classData.class_size as any,
        durationType: classData.duration_type as any,
        ...
        curriculum: curriculumData?.map(item => ({
          ...
          learningObjectives: (item as any).learning_objectives || [],
